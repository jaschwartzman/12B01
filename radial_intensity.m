...
filePattern = fullfile(current_directory, 'PHA_10x_1_FITC.tif'); 
...
for i = 1:length(AllProfiles)
    ...
    headers = {'eGFP_signal','Nile_mKate_signal'};
    data=table(output',output_Tx','Variablenames',headers);
    
%     writetable(data,title); %UNCOMMENT IF YOU WANT TO OUTPUT DATA
end
